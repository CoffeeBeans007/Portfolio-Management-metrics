...
print("S&P500 Returns: ", sp_returns)
#Regress using scipy and show statistics
from scipy import stats

#Match both returns on index
returns = returns[sp_returns.index]
slope, intercept, r_value, p_value, std_err = stats.linregress(list(sp_returns)[1:], list(returns)[1:])
#Display all stats
print("Slope: ", slope)
