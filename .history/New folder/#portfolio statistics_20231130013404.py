...
PF_Ref= np.array([0.35*ReturnSPTSX, 0.2*sp_returns, 0.1*ReturnsXINCad, 0.15*ReturnsaLT, 0.1*ReturnsXBB]).T
PF_Ref_df= pd.DataFrame(PF_Ref,columns=["CAN", "US", "INT", "ALT", "OB"])
