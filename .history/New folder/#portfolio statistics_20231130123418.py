...
ReturnSPTSX = yf.download('^GSPTSE', start='2023-09-07', end='2023-11-23', progress=False)['Adj Close'].pct_change()*100
print(np.sum(ReturnSPTSX))
ReturnsXSPCad = yf.download('XSP.TO', start='2023-09-07', end='2023-11-23', progress=False)['Adj Close'].pct_change()*100
print(np.sum(ReturnsXSPCad))
ReturnsXINCad = yf.download('XIN.TO', start='2023-09-07', end='2023-11-23', progress=False)['Adj Close'].pct_change()*100
print(np.sum(ReturnsXINCad))

ReturnsaLT = yf.download('CMR.TO', start='2023-09-07', end='2023-11-23', progress=False)['Adj Close'].pct_change()*100
print(ReturnsaLT)
ReturnsXBB = yf.download('XBB.TO', start='2023-09-07', end='2023-11-23', progress=False)['Adj Close'].pct_change()*100
