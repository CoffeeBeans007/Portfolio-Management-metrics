...
returnss=returns
sp_returns = yf.download('^GSPC', start='2023-09-01', end='2023-11-21', progress=False)['Adj Close'].pct_change()
...
#Plot s&p, PF, and PF_ref
#
print(returnss)
import plotly.graph_objects as go

cumulative_PF_Ref = (1 + PF_Ref_df["Total_Returns"]).cumprod() - 1
cumulative_sp_returns = (1 + sp_returns).cumprod() - 1
cumulative_returnss = (1 + returnss).cumprod() - 1
